      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <div class="logo flex justify-between items-center ml-[-18px] py-72">
              <img src="{{ asset('assets/logo/logo-fina.png') }}" alt="" style="width: 60px; height: 75px; margin-top: 5px;">
              {{-- <span class="text-[#1B1684] text-2xl text-center font-bold">
                Pov Bopheak Land
              </span> --}}
            </div>
        ...
        <ul  class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('view_about') }}" class="menu-link">
                  <div data-i18n="Without menu">View About</div>
                </a>
              </li>
              <li class="menu-item d-none">
                <a href="{{ route('add_about') }}" class="menu-link">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('customer.index') }}" class="menu-link">
                  <div data-i18n="Without menu">View Customer</div>
                </a>
              </li>
              <li class="menu-item d-none">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-trending-up text-2xl"></i>
              <div data-i18n="Layouts">News</div>
            </a>

            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('newslatest.index') }}" class="menu-link">
                  <div data-i18n="Without menu">View News</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{ route('newslatest.create') }}" class="menu-link">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="../../assets/profile/{{ Auth::User()->profile }}" alt
